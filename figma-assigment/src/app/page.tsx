    ...
    <div>
      ...
      <div className="flex justify-center items-center my-[100px]">
        ...
        <div className="w-1/2">
          ...
          <p className="mt-[40px] w-[600px] text-[28px] text-[#A29875] font-serif">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam quas, consequuntur consectetur dolorem impedit beatae magni repudiandae provident.</p>
